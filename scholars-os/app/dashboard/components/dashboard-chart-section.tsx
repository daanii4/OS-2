...
export function DashboardChartSection({ variant = 'desktop' }: Props) {
  ...
  if (variant === 'mobile') {
    return (
      <section className="os-card os-card-interactive">
        ...
        <div className="flex h-[200px] w-full min-w-0 items-end justify-start rounded-md bg-[var(--surface-inner)] p-2">
          {chartError ? (
  ...
  return (
    <section className="os-card os-card-interactive min-w-0 overflow-hidden">
      ...
      <div className="flex h-[200px] w-full min-w-0 items-end justify-start rounded-md bg-[var(--surface-inner)] p-3 sm:h-[240px]">
        {chartError ? (
